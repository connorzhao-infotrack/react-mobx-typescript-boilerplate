...
import TodoListIndexKey from '../../components/TodoListIndexKey/index';

export const IndexKey = observer(() => {
  ...
  const addOneAndRemoveOne = () => {
    // todoStore.deleteSecond();
    todoStore.todos.splice(1, 0, new TodoModel('Use MobX'));
    // todoStore.addTodo(new TodoModel('Use MobX'));
  };

  return (
    <div>
      <button onClick={addOneAndRemoveOne}>add one and remove one</button>
